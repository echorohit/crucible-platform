...
#
apr_builddir=/usr/local/cruciform/lib/apache/build
apr_builders=/usr/local/cruciform/lib/apache/build
top_builddir=/usr/local/src/httpd-2.2.18/srclib/apr

# Some layouts require knowing what version we are at.
APR_MAJOR_VERSION=1
APR_DOTTED_VERSION=1.4.4
