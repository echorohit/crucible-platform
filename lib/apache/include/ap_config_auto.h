...
/* Location of the MIME types config file, relative to the Apache root
   directory */
#define AP_TYPES_CONFIG_FILE "/etc/cruciform//mime.types"
...
#define HTTPD_ROOT "/usr/local/cruciform/lib/apache"
...
#define SERVER_CONFIG_FILE "/etc/cruciform//httpd.conf"
