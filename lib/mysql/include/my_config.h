...
#define DEFAULT_MYSQL_HOME "/usr/local/cruciform/lib/mysql"
#define SHAREDIR "/usr/local/cruciform/lib/mysql/share"
#define DEFAULT_BASEDIR "/usr/local/cruciform/lib/mysql"
#define MYSQL_DATADIR "/var/lib/cruciform/mysql"
#define DEFAULT_CHARSET_HOME "/usr/local/cruciform/lib/mysql"
#define PLUGINDIR "/usr/local/cruciform/lib/mysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/etc/cuciform"
