...
/* Location of the MIME types config file, relative to the Apache root
   directory */
#define AP_TYPES_CONFIG_FILE "/usr/local/lamp_dev_64/etc/mime.types"
...
#define HTTPD_ROOT "/usr/local/lamp_dev_64/apache"
...
#define SERVER_CONFIG_FILE "/usr/local/lamp_dev_64/etc/httpd.conf"
