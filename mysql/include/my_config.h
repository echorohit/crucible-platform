...
#define DEFAULT_MYSQL_HOME "/usr/local/lamp_dev_64/mysql"
#define SHAREDIR "/usr/local/lamp_dev_64/mysql/share"
#define DEFAULT_BASEDIR "/usr/local/lamp_dev_64/mysql"
#define MYSQL_DATADIR "/usr/local/lamp_dev_64/mysql/data"
#define DEFAULT_CHARSET_HOME "/usr/local/lamp_dev_64/mysql"
#define PLUGINDIR "/usr/local/lamp_dev_64/mysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/lamp_dev_64/etc"
